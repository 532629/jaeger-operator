...
--------------------------
    root@devopslab:/home/ubuntu# helm repo add jaegertracing https://jaegertracing.github.io/helm-charts
    "jaegertracing" has been added to your repositories
    root@devopslab:/home/ubuntu#


    root@devopslab:/home/ubuntu# helm repo list
    NAME            URL
    ...
    root@devopslab:/home/ubuntu/jaeger# helm repo add jaegertracing https://jaegertracing.github.io/helm-charts
    ...
    root@devopslab:/home/ubuntu/jaeger#


  root@devopslab:/home/ubuntu/jaeger# helm install helm-jaeger-operator -n tracing jaeger-operator
  ...
  Check the jaeger-operator logs
    ...
    root@devopslab:/home/ubuntu/jaeger# kubectl get pods -n tracing
    NAME                                    READY   STATUS    RESTARTS   AGE
    helm-jaeger-operator-554467bd7b-6ggww   1/1     Running   0          111s

    root@devopslab:/home/ubuntu/jaeger# kubectl get svc -n tracing
    NAME                           TYPE       CLUSTER-IP      EXTERNAL-IP   PORT(S)          AGE
    helm-jaeger-operator-metrics   NodePort   10.105.57.133   <none>        8383:30037/TCP   2m

    root@devopslab:/home/ubuntu/jaeger# kubectl get crd -n tracing
    NAME                       CREATED AT
    jaegers.jaegertracing.io   2020-09-03T23:13:51Z
    root@devopslab:/home/ubuntu/jaeger#


    root@devopslab:/home/ubuntu/jaeger/jaeger-instance# kubectl create -f simplest.yaml
    jaeger.jaegertracing.io/simplest created
    root@devopslab:/home/ubuntu/jaeger/jaeger-instance#

    root@devopslab:/home/ubuntu/jaeger/jaeger-instance# kubectl get pods -n tracing
    NAME                                    READY   STATUS    RESTARTS   AGE
    helm-jaeger-operator-554467bd7b-6ggww   1/1     Running   0          5m53s
    simplest-5d674b68b8-stgnb               1/1     Running   0          30s


    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl get svc -n tracing
    NAME                           TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)                                  AGE
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples#

    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl get ingress -n tracing
...
--------------------------------
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl create -n observability -f operator-with-tracing.yaml
    deployment.apps/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples#


    root@devopslab:/home/ubuntu/jaeger# kubectl create -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/crds/jaegertracing.io_jaegers_crd.yaml
    customresourcedefinition.apiextensions.k8s.io/jaegers.jaegertracing.io created
    root@devopslab:/home/ubuntu/jaeger# kubectl create -n observability -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/service_account.yaml
    serviceaccount/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger# kubectl create -n observability -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/role.yaml
    role.rbac.authorization.k8s.io/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger# kubectl create -n observability -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/role_binding.yaml
    rolebinding.rbac.authorization.k8s.io/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger# kubectl create -n observability -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/operator.yaml
    deployment.apps/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger#
    ...
    root@devopslab:/home/ubuntu/jaeger# kubectl create -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/cluster_role.yaml
    clusterrole.rbac.authorization.k8s.io/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger# kubectl create -f https://raw.githubusercontent.com/jaegertracing/jaeger-operator/master/deploy/cluster_role_binding.yaml
    clusterrolebinding.rbac.authorization.k8s.io/jaeger-operator created
    root@devopslab:/home/ubuntu/jaeger#

    root@devopslab:/home/ubuntu/jaeger# kubectl get deployment jaeger-operator -n observability
    NAME              READY   UP-TO-DATE   AVAILABLE   AGE
    jaeger-operator   1/1     1            1           2m33s
    root@devopslab:/home/ubuntu/jaeger#


    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl get pods -n observability
    NAME                               READY   STATUS    RESTARTS   AGE
    ...
    root@devopslab:/home/ubuntu/jaeger# kubectl get jaeger -n observability
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl get pods  -l  app.kubernetes.io/instance=simplest -n observability
    NAME                        READY   STATUS    RESTARTS   AGE
    simplest-574989b7bf-p4c5p   1/1     Running   0          78m
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl logs  -l  app.kubernetes.io/instance=simplest -n observability
    ...
    root@devopslab:/home/ubuntu/jaeger# kubectl describe jaegers simplest
    Name:         simplest
    Namespace:    default
    Labels:       <none>
    ...
    root@devopslab:/home/ubuntu/jaeger# kubectl describe jaegers simplest -n observability
    Name:         simplest
    ...
    root@devopslab:/home/ubuntu/jaeger# kubectl get ingress -n observability
    NAME             CLASS    HOSTS   ADDRESS   PORTS   AGE
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# helm install my-ingress-nginx  ingress-nginx/ingress-nginx -n observability
  ...
  root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl exec -it $POD_NAME -- /nginx-ingress-controller --version
  -------------------------------------------------------------------------------
  ...
  -------------------------------------------------------------------------------
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl --namespace observability get services
    NAME                          TYPE        CLUSTER-IP       EXTERNAL-IP   PORT(S)                                  AGE
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# kubectl apply -f hotrodweb.yaml
    ...
    root@devopslab:/home/ubuntu/jaeger/git/jaeger-operator/deploy/examples# telnet 10.96.72.180 14268
    Trying 10.96.72.180...
